package com.luck.picture.lib2.camera;
...
import com.luck.picture.lib2.PictureMediaScannerConnection;
import com.luck.picture.lib2.R;
import com.luck.picture.lib2.camera.listener.CameraListener;
import com.luck.picture.lib2.camera.listener.CaptureListener;
import com.luck.picture.lib2.camera.listener.ClickListener;
import com.luck.picture.lib2.camera.listener.ImageCallbackListener;
import com.luck.picture.lib2.camera.listener.TypeListener;
import com.luck.picture.lib2.camera.view.CaptureLayout;
...
public class CustomCameraView extends RelativeLayout {
    ...
    public void initView() {
        ...
        mSwitchCamera.setImageResource(R.drawable.picture_ic_camera1);
    ...
    private void setFlashRes() {
        switch (type_flash) {
            case TYPE_FLASH_AUTO:
                mFlashLamp.setImageResource(R.drawable.picture_ic_flash_auto1);
                mCameraView.setFlash(ImageCapture.FLASH_MODE_AUTO);
                break;
            case TYPE_FLASH_ON:
                mFlashLamp.setImageResource(R.drawable.picture_ic_flash_on1);
                mCameraView.setFlash(ImageCapture.FLASH_MODE_ON);
                break;
            case TYPE_FLASH_OFF:
                mFlashLamp.setImageResource(R.drawable.picture_ic_flash_off1);
