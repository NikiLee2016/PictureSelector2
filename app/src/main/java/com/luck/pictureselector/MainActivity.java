...
import com.luck.picture.lib2.broadcast.BroadcastAction;
import com.luck.picture.lib2.broadcast.BroadcastManager;
...
import com.luck.picture.lib2.language.LanguageConfig;
import com.luck.picture.lib2.listener.OnCustomCameraInterfaceListener;
import com.luck.picture.lib2.listener.OnCustomImagePreviewCallback;
import com.luck.picture.lib2.listener.OnResultCallbackListener;
import com.luck.picture.lib2.listener.OnVideoSelectedPlayCallback;
import com.luck.picture.lib2.permissions.PermissionChecker;
import com.luck.picture.lib2.style.PictureCropParameterStyle;
import com.luck.picture.lib2.style.PictureParameterStyle;
import com.luck.picture.lib2.style.PictureSelectorUIStyle;
    ...
    public void onCheckedChanged(RadioGroup group, @IdRes int checkedId) {
        switch (checkedId) {
            ...
            case R.id.rb_photo_up_animation:
                mWindowAnimationStyle = PictureWindowAnimationStyle.ofCustomWindowAnimationStyle(R.anim.picture_anim_up_in1, R.anim.picture_anim_down_out1);
                break;
...
//        mPictureParameterStyle.pictureOriginalTextSize = 14;
    ...
    private PictureParameterStyle getWeChatStyle() {
        ...
        mPictureParameterStyle.pictureCompleteBackgroundStyle = R.drawable.picture_send_button_bg1;
        // 选择相册目录背景样式
        mPictureParameterStyle.pictureAlbumStyle = R.drawable.picture_new_item_select_bg;
        // 相册列表勾选图片样式
